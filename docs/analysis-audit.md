...
(worst decile 0.019 vs the 0.01 threshold). Three diagnosed rounds — extra
short-range distance knots, family-specific distance slopes (a 5-ft putback
is not a 5-ft jump shot), and driving/cutting/running modifiers plus court
side — brought the worst decile to 0.0098. The gate was left at 0.01 rather
